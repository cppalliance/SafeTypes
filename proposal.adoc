...
. No operators defined between Boost.SafeNumbers and builtin numeric types except for explicit, and non-narrowing construction
...
try
{
    using namespace boost::safenumbers;
